...
const prefix = ['$'];
const client = new Discord.Client("NzM5MzkwMjk4NTM0MTgzMDA0.XyZxXg.wLz1guD-28soQLbhxyrrjbjmtVY");
const client2 = new Discord.Client("NzM5MzkxMjY4MTM1NzYzOTg5.XyZyDQ.76Mrxqluk_Ts54HdazQz236__W4");
const client3 = new Discord.Client("NzM5MzkxOTI5ODAzODY2MTk1.XyZyyA.jHbKmkWO64gL4kGAuRNmgvrkXi8");
const client4 = new Discord.Client("NzM5MzkyNTAwOTQ2NTY3MjM5.XyZzaw.QmDnOV7mhZ30Z6cAHZvM97Qv-Dk");
const client5 = new Discord.Client("NzM5MzkzNDA1NjQxMTYyODIz.XyZ0Ew.4A_A1IqnNWgiKmI9uLzfUaSbV7s");
const client6 = new Discord.Client("NzM5MzkzODY4MzgxOTQ1OTU3.XyZ0pQ.nC93Ard-qXEpVz3n6-ZK93rC4vE");
